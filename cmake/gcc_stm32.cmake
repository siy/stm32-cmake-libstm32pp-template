...
FUNCTION(STM32_ADD_HEX_BIN_TARGETS TARGET)
    SET(CMAKE_EXE_LINKER_FLAGS_DEBUG "-Xlinker -Map=${TARGET}.map" CACHE INTERNAL "linker flags debug")
    ...
    ENDIF()
    ADD_CUSTOM_TARGET(${TARGET}.hex ALL DEPENDS ${TARGET}.elf COMMAND ${CMAKE_OBJCOPY} -Oihex ${FILENAME} ${FILENAME}.hex)
    ADD_CUSTOM_TARGET(${TARGET}.bin ALL DEPENDS ${TARGET}.elf COMMAND ${CMAKE_OBJCOPY} -Obinary ${FILENAME} ${FILENAME}.bin)
ENDFUNCTION()
...
FUNCTION(STM32_SET_TARGET_PROPERTIES TARGET)
    ...
    IF((NOT STM32_FLASH_SIZE) OR (NOT STM32_RAM_SIZE))
        ...
        ENDIF()
    ENDIF()
    STM32_SET_FLASH_PARAMS(${TARGET}.elf ${STM32_FLASH_SIZE} ${STM32_RAM_SIZE})
    STM32_SET_CHIP_DEFINITIONS(${TARGET}.elf ${STM32_CHIP_TYPE})
...
FUNCTION(STM32_SET_HSE_VALUE TARGET STM32_HSE_VALUE)
    ...
    ENDIF()
    SET_TARGET_PROPERTIES(${TARGET}.elf PROPERTIES COMPILE_DEFINITIONS "${TARGET_DEFS}")
ENDFUNCTION()
