...
SET(CMAKE_CXX_FLAGS "-mthumb -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -Wall -std=c++17 -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffast-math -ftree-vectorize" CACHE INTERNAL "cxx compiler flags")
...
FUNCTION(STM32_SET_CHIP_DEFINITIONS TARGET CHIP_TYPE)
    ...
    IF(TARGET_DEFS)
        SET(TARGET_DEFS "STM32F3XX;STM32F${CHIP_TYPE_2};${TARGET_DEFS}")
    ELSE()
        SET(TARGET_DEFS "STM32F3XX;STM32F${CHIP_TYPE_2}")
    ENDIF()
