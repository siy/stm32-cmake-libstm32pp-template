...
SET(CMAKE_CXX_FLAGS "-mthumb -fno-builtin -mcpu=cortex-m7 -mfpu=fpv5-sp-d16 -mfloat-abi=softfp -Wall -std=c++17 -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffast-math -ftree-vectorize" CACHE INTERNAL "cxx compiler flags")
...
FUNCTION(STM32_SET_CHIP_DEFINITIONS TARGET CHIP_TYPE)
    ...
    IF(TARGET_DEFS)
        SET(TARGET_DEFS "STM32F7XX;STM32F${CHIP_TYPE};${TARGET_DEFS}")
    ELSE()
        SET(TARGET_DEFS "STM32F7XX;STM32F${CHIP_TYPE}")
    ENDIF()
